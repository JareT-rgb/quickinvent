...
class AppSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final darkGreen = Theme.of(context).brightness == Brightness.dark ? Colors.grey.shade900 : const Color(0xFF1B5E20);
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.shopping_cart, color: darkGreen, size: 24),
                ),
          ...
          _buildItem(context, Icons.settings, 'Configuración', 'settings'), // Nueva opción
          const Spacer(),
          // Perfil Admin
          Container(

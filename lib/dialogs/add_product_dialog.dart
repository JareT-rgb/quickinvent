...
class _AddProductDialogState extends ConsumerState<AddProductDialog>
          ...
          Expanded(
            ...
            child: Column(
              children: [
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              keyboardType: TextInputType.number,
                              decoration: appInputDecoration(context, label: 'Stock Inicial', icon: Icons.unarchive_rounded),
                            ),
                          ),
                ...
                const SizedBox(height: 24),
                _buildTipCard('El stock mínimo activa alertas automáticas cuando el inventario está por agotarse.'),
              ],
            ),
          ),
        ],
  ...
  Widget _buildTipCard(String tip) {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.lightbulb_rounded, size: 24, color: AppTheme.primary),
          const SizedBox(width: 16),
          Expanded(
            child: Text(
              tip,
...
class _ActionButton extends StatelessWidget {
  ...
  const _ActionButton({required this.icon, required this.onPressed, this.tooltip});
